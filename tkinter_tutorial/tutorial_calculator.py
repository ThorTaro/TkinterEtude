...
"""
    京都大学学術情報リポジトリにて無料公開されているpythonチュートリアルの資料掲載のコードをそのまま実装．
    (URL: https://repository.kulib.kyoto-u.ac.jp/dspace/handle/2433/245698)
    資料内での各用語の説明の順番の都合上，クラスという概念が使えなかったため，グローバル変数を乱用するという
    方針をとっているのではないかと考えられる．
    流石にこのままでは使いにくいため，自前で用意する方針に変更．
"""
